...
/**
 * Phase C1.C (2026-05-19): Effects-Overlay-Component. Wird über dem Video
 * gerendert um die FFmpeg-eq Live-Preview zu approximieren. RN hat keinen
 * nativen Video-ColorMatrix-Filter, daher diese rudimentären semi-trans-
 * parenten Layer:
 *
 ...
 * Shader-Lib (Skia/expo-gl) — werden erst beim Cloud-Export via FFmpeg
 * eq/unsharp/tmix angewendet (voll wirksam dort).
 *
 * Wird auch in FullModePreview + StackedSplitPreview (ProjectDetailScreen)
 * eingebunden — daher exported.
 */
export function EffectsOverlay({
  ...
  const layers = computeEffectsOverlay(effects);
