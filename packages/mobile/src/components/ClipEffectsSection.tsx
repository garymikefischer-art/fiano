    ...
    >
      ...
      {expanded && (
        <View style={{ gap: 16, marginTop: 4 }}>
          ...
          {/* K-4 (SECURITY_AUDIT_2026-06-10): Motion-Blur-Option ENTFERNT.
              FFmpeg minterpolate war der teuerste Cloud-Render-Pfad (~5–10× CPU)
              und damit der Haupt-Denial-of-Wallet-Hebel. Der Worker ignoriert
              motionBlur seit 2026-06-17 ohnehin serverseitig (renderSpec.ts).
              User-Entscheidung: auf Mobile nicht nötig → Option ganz raus. */}
        </View>
      )}
    </View>
  );
