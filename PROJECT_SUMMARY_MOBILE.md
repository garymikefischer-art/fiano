...
> ✅ **BUILD 18 FERTIG + 16-KB-VERIFIZIERT (2026-06-08):** EAS-Build `47b6d255` (commit `574eb4f`, **v0.0.5, vCode 18, runtime 0.0.5**) finished. AAB: `https://expo.dev/artifacts/eas/9RC8GALYjs8b9NPguwHjoY.aab` (lokal `~/Downloads/fisora-build18-v0.0.5-vc18.aab`, 68 MB). 16-KB verifiziert (alle 42 64-bit-.so LOAD-Align ≥0x4000). **Bündelt ALLE heutigen Fixes im Binary** (URL-Import, Popup-AppAlert-Look, Abo-Replacement/Resume/Poll) → kein OTA-Pull/Update-Popup bei neuen Nutzern. Re-Test (SDK 52→53) auf Vivo war grün. 🔴 **SOFORT:** AAB in Play Console → **Produktion → „Neuen Release erstellen"** (Build 18 hochladen, vCode 18 > 16/17) → einreichen. 16-KB-Warnung darf NICHT erscheinen. 12-Tester/14-Tage-Regel im Dashboard prüfen. (Build 17/0.0.4 bleibt im Closed Test; Build 16/0.0.3 = abgelehnt.)
